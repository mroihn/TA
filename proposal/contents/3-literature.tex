...
Berdasarkan \cite{Donovan2018Reflective} dan \cite{Rampelotto2023PeerReview}, alur kerja sistem publikasi ilmiah konvensional dapat didefinisikan sebagai tabel berikut:

\begin{xltabular}{\textwidth}{|c|l|X|}
\caption{Alur Kerja Sistem Publikasi Ilmiah Konvensional}
\label{table:workflow-conventional} \\

\hline
\rowcolor[HTML]{EFEFEF}
\textbf{No.} & \multicolumn{1}{c|}{\textbf{Nama Tahap}} & \multicolumn{1}{c|}{\textbf{Deskripsi}} \\
\hline
\endfirsthead

\multicolumn{3}{c}{{\tablename\ \thetable{}: Alur Kerja Sistem Publikasi Ilmiah Konvensional}} \\
\hline
\rowcolor[HTML]{EFEFEF}
\textbf{No.} & \multicolumn{1}{c|}{\textbf{Nama Tahap}} & \multicolumn{1}{c|}{\textbf{Deskripsi}} \\
\hline
...
1 & \textbf{\textit{Submission}} &
Penulis mengajukan naskah melalui sistem submission jurnal beserta seluruh materi dan dokumentasi yang diperlukan. \\
\hline

2 & \textbf{\textit{Initial Check}} &
Staf jurnal melakukan pemeriksaan awal, termasuk verifikasi kepatuhan terhadap kebijakan editorial, standar etika, format penulisan, serta screening plagiarisme. \\
\hline

3 & \textbf{\textit{Editorial Pre-check}} &
Editor akademik mengevaluasi merit ilmiah, metodologi, kejelasan penulisan, dan kesesuaian naskah dengan ruang lingkup jurnal untuk menentukan kelanjutan ke tahap peer review atau penolakan awal. \\
\hline

4 & \textbf{\textit{Peer Review}} &
Reviewer eksternal menilai kualitas, kekokohan ilmiah, dan signifikansi naskah dalam jangka waktu tertentu serta memberikan rekomendasi. \\
\hline

5 & \textbf{\textit{Editorial Post-review}} &
Editor mempertimbangkan masukan reviewer dan menetapkan keputusan editorial: diterima, revisi minor/mayor, ditolak dengan opsi pengajuan ulang, atau penolakan final. \\
\hline

6 & \textbf{\textit{Revision and Resubmission}} &
Penulis melakukan revisi naskah berdasarkan komentar reviewer dan mengajukan ulang disertai respons point-by-point. \\
\hline

7 & \textbf{\textit{Final Acceptance}} &
Editor mengeluarkan keputusan penerimaan editorial bersifat provisional setelah substansi ilmiah dinilai memadai, sambil menunggu pemeriksaan teknis dan format akhir. \\
\hline

8 & \textbf{\textit{Publication}} &
Artikel dipublikasikan secara elektronik dengan penugasan DOI dan selanjutnya dapat dimasukkan ke dalam edisi cetak jurnal. \\
\hline

9 & \textbf{\textit{Post-Publication}} &
Laporan open peer review (jika tersedia) dipublikasikan bersama artikel, serta artikel diindeks dalam basis data ilmiah dengan pelacakan sitasi berkelanjutan. \\
\end{xltabular}
